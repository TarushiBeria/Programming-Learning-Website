<?php
    ...
    $select = mysqli_query($connection,"SELECT member.name as m, courses.name as c, email FROM `courses` natural join `staff` inner join `member` on staff.m_id = member.m_id");
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <?php
            ...
            if($_SESSION['email'] == "manoj.beria183@nmims.edu.in"){
              ...
              echo'</li>';
              echo'<li class="nav-item">';
                echo'<a class="nav-link active" href="courses_report.php">Courses Report</a>';
              echo'</li>';
            }
          ?>
        </ul>
